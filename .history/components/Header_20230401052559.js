...
function Header() {
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white/95 shadow-md p-5 backdrop-blur-md backdrop-brightness-200 backdrop-opacity-10 md:backdrop-blur-lg md:px-10 border-b-2 border-gray-300">
      {/* left */}
      ...
      <div className="flex space-x-4 items-center justify-end text-gray-600">
        <p className="hidden md:inline cursor-pointer hover:bg-gray-100 py-2 px-6 rounded-full items-center">Airbnb your home </p>
