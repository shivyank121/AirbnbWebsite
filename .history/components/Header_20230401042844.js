...
function Header() {
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white/40 shadow-md p-5 backdrop-blur-md backdrop-brightness-200 backdrop-opacity-10 md:backdrop-blur-lg md:px-10">
      {/* left */}
